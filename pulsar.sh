...
case $(uname -m) in
  arm64)
    downloadURL="${gitHubURL}/releases/download/${latestReleaseTag}/Silicon.Mac.Pulsar-${currentVers}-arm64.dmg"
    ;;

  x86_64)
    downloadURL="${gitHubURL}/releases/download/${latestReleaseTag}/Intel.Mac.Pulsar-${currentVers}.dmg"
    ;;
